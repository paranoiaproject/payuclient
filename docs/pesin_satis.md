...
Aşağıdaki örnek kod, peşin satış işlemini gerçekleştirmektedir. Örnekde kullanılan tüm parametreler zorunludur. Opsiyonel parametreler için referans dökünınını inceleyebilirsiniz.
